...
const LaunchCard: React.FC<LaunchCardProps> = ({ launch }) => {
  ...
  return (
    ...
    >
      <Box
        maxW={{ base: "100%", md: "200px", lg: "300px" }}
        w={{ base: "100%", md: "100%", lg: "300px" }}
        h={{ base: "200px", md: "100%", lg: "300px" }}
        bg="gray.100"
        display="flex"
      ...
      <Stack py={{ base: 16, md: 4 }} width="100%">
        <CardBody>
          <Heading size="md" mb={2}>
            {launch.name}
          </Heading>
          <Stack py={4} gap={8} direction={{ base: "column", md: "row" }}>
            <InfoBox label="Mission" text={launch.name} />
            <InfoBox
              label="Date"
              text={
            ...
            />
            <InfoBox label="Launchpad" text={launchpadName || "Unknown"} />
            <InfoBox
              label="Status"
              text={
                <Badge
